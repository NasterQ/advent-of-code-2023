...
const partsIndexes: SymbolsList[] = findSymbols(dataRows, regParts);
...
const result: number = resultWithoutAsterisks + resultWithAsterisks;

// Because of my misunderstating, in this code we calculate the result as the sum of other parts + sum of the gears
console.log(result);
